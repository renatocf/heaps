...
static void BM_DijkstraMinimumPathWithBinaryHeap(benchmark::State& state) {
  ...
  while (state.KeepRunning()) {
    ...
    auto path = graph::dijkstra<heap::Binary>(graph, 0, num_nodes-1);
...
BENCHMARK(BM_DijkstraMinimumPathWithBinaryHeap)
